...
#if USE_6LOWPAN
extern "C" {
    #include "contiki/sicslowpan.h"
	#include "contiki/netstack.h"
	#include "contiki/uip.h"
	#include "contiki/tcpip.h"
	#include "contiki/uipopt.h"
	#include "contiki/uip-icmp6.h"
	#include "contiki/packetbuf.h"
	#include "contiki/queuebuf.h"
	#include "contiki/contract.h"
	#include "contiki/uip-nd6.h"
...
class sixlowpan : public cSimpleModule
{
  protected:
  ...
  private:
    ...
    IPv6Datagram* processLowpanPacket(sixlowpanDatagram* packet);
