...
bool sixlowpan::isConnectedToLowpan(cGate *toMac)
{
	if(toMac != null)
	{
...
void sixlowpan::switchContext(int context)
{
#if USE_6LOWPAN
#if DEBUG
...
void sixlowpan::saveContext(int context)
{
#if USE_6LOWPAN
#if DEBUG
...
void sixlowpan::registerContext(int context)
{
#if USE_6LOWPAN
#if SICSLOWPAN_CONF_COMPRESSION == SICSLOWPAN_COMPRESSION_HC06
...
void sixlowpan::handleMessage(cMessage *msg)
{
#if DEBUG
...
void sixlowpan::handleMessageFromHigher(cMessage *msg)
{
...
void sixlowpan::handleMessageFromLower(cMessage *msg)
{
    // Identify the memory slot, necessary to simulate Contiki instances
	int gateIndex = msg->getArrivalGate()->getIndex();
#if USE_6LOWPAN
...
list<cPacket*> sixlowpan::processIPv6Packet(IPv6Datagram* ipPacket, int gateIndex)
{
...
IPv6Datagram* sixlowpan::processLowpanPacket(sixlowpanDatagram* packet)
{
